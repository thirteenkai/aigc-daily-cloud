...
候选入口包含官方日报、24小时精选，以及视频、图像、音频、音乐、语音、数字人、短剧的24小时公开池检索。`creative_search_24h`不是精选背书；关键词命中只表示进入候选，相关新闻可能并非创作工具更新。逐条核对真实相关性与来源，把员工声明、用户实验、平台宣传写成相应归属，不把体验或转发提升为官方能力保证。新收录的旧消息要明确原发布日。`creativeCoverage`必须记录每个检索方向及完整分页；入口失败时不能按“无创作新闻”继续发布。
